...
b1 = a1.filter(function (x) { return x >= 5; });
console.log(b1);
//map함수
//수학은 벡터 연산이 기본이다
//y= f(x)
...
b1 = a1.map(function (x) { return x * 3; });
console.log(b1);
b1 = a1.map(function (x) { return x * x; });
console.log(b1);
